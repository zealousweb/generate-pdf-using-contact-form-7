		...
		*/
		function wpcf7_pdf_attachment_script( $wpcf7 ){
			...
			if($setting_data['cf7_pdf_link_is_enable'] == 'false') {
				...
				setcookie( $cookie_name, $cookie_value, time() + (86400 * 1), "/"); // 86400 = 1 day phpcs:ignore
				setcookie( 'wp-enable_pdf_link', $cf7_pdf_link_is_enable, time() + (86400 * 1), "/"); // 86400 = 1 day phpcs:ignore
			}
						...
						if($attach_image)
		 				{
							...
							if($setting_data['cf7_pdf_link_is_enable'] == 'true'){
			 					$cookie_name = "wp-pdf_path";
								$cookie_value = $attdataurl;
								setcookie( $cookie_name, $cookie_value, time() + (86400 * 1), "/"); //phpcs:ignore 86400 = 1 day 
								setcookie( 'wp-enable_pdf_link', $cf7_pdf_link_is_enable, time() + (86400 * 1), "/"); //phpcs:ignore 86400 = 1 day 
								setcookie( 'wp-pdf_download_link_txt', $cf7_pdf_download_link_txt, time() + (86400 * 1), "/"); //phpcs:ignore 86400 = 1 day 
								setcookie( 'wp-unit_tag', $unit_tag, time() + (86400 * 1), "/"); //phpcs:ignore 86400 = 1 day 
							} 
